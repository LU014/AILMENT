...
SG_CRC_GE <- read.csv("SingaporeCRC_data/SG_CRC_GE.csv")
X <- SG_CRC_GE[, !names(SG_CRC_GE) %in% c('TMB', 'KRAS_y', 'BRAF_y', 'NRAS_y', 'TP53_y',
                                          ...
                                          'Side', 'Grade', 'TNM', 'Stage', 'iCMS', 'CMS', 'group3', 'group5','Vital.status')]
