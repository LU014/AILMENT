...
ggplot(alpha_diversity, aes(x = MSI.Status, y = Shannon, fill = MSI.Status)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.2, size = 2, alpha = 0.6) +
  geom_signif(comparisons = list(c("MSI", "MSS")),  
              map_signif_level = TRUE, test = "wilcox.test") +  
  scale_fill_brewer(palette = "Set2") +
  theme_classic() +
  labs(title = "SG_MSI_Status", x = "", y = "") +
  theme(
    plot.title = element_text(hjust = 0.5, size = 14),
    axis.title = element_text(face = "bold", size = 13),
    axis.text = element_text(size = 13),
...
ggplot(alpha_diversity, aes(x = Stage, y = Shannon, fill = Stage)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.2, size = 2, alpha = 0.6) +
  geom_signif(comparisons = list(c("Early Stage", "Late Stage")), 
              map_signif_level = TRUE, test = "wilcox.test") + 
  scale_fill_brewer(palette = "Set2") +
  theme_classic() +
  labs(title = "SG_Tumor_Stage", x = "", y = "") +
  theme(
    plot.title = element_text(hjust = 0.5, size = 14),
    axis.title = element_text(face = "bold", size = 13),
    axis.text = element_text(size = 13),
...
ggplot(alpha_diversity, aes(x = Site.of.Primary.Colorectal.tumour, y = Shannon, fill = Site.of.Primary.Colorectal.tumour)) +
  ...
  theme_classic() +
  labs(title = "SG_Tumor_Location", x = "", y = "") +
  theme(
    plot.title = element_text(hjust = 0.5, size = 14),
    axis.title = element_text(face = "bold", size = 13),
    axis.text = element_text(size = 13),
...
ggplot(pcoa_bray_df, aes(x = Axis1, y = Axis2, color = BRAF, shape = BRAF)) +
  ...
  stat_ellipse(aes(fill = BRAF), geom = "polygon", alpha = 0.2, level = 0.95) + 
...
ggplot(pcoa_bray_df, aes(x = Axis1, y = Axis2, color = MSI.Status, shape = MSI.Status)) +
  geom_point(size = 3, alpha = 0.8) +
  stat_ellipse(aes(fill = MSI.Status), geom = "polygon", alpha = 0.2, level = 0.95) + 
  scale_color_brewer(palette = color_palette) +
  scale_fill_brewer(palette = color_palette, guide = "none") +
  theme_classic() +
  labs(
...
ggplot(pcoa_bray_df, aes(x = Axis1, y = Axis2, color = Stage, shape = Stage)) +
  geom_point(size = 3, alpha = 0.8) +
  stat_ellipse(aes(fill = Stage), geom = "polygon", alpha = 0.2, level = 0.95) +
  scale_color_brewer(palette = color_palette) +
  scale_fill_brewer(palette = color_palette, guide = "none") +
  theme_classic() +
  labs(
    title = "SG_Tumor_Stage",
    x = axis1_label,
    y = axis2_label,
    color = "Group",  
    shape = "Group"   
...
ggplot(pcoa_bray_df, aes(x = Axis1, y = Axis2, color = Site.of.Primary.Colorectal.tumour, shape = Site.of.Primary.Colorectal.tumour)) +
  geom_point(size = 3, alpha = 0.8) +
  stat_ellipse(aes(fill = Site.of.Primary.Colorectal.tumour), geom = "polygon", alpha = 0.2, level = 0.95) + 
  scale_color_brewer(palette = color_palette) +
  scale_fill_brewer(palette = color_palette, guide = "none") +
  theme_classic() +
  labs(
    title = "SG_Tumor_Location",
    x = axis1_label,
    y = axis2_label,
    color = "Group",  
    shape = "Group"   
